    <footer class="pt-65 bg-dark .bg-dark-changeless">
        <div class="container">
            <div class="row mb-65">
                <div class="col-md-6">
                    <div class="logo wow fadeIn animated">
                        <a href="index-2.html"> <img src="assets/imgs/theme/logo-white.svg" alt="flow"></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="d-flex text-right text-sm-left align-self-center justify-content-end wow fadeIn animated">
                        <h5 class="mr-15 text-white changeless mb-0 align-self-center">All you need to build new site</h5>
            ...
            <div class="footer-copy-right pt-30 mt-20 wow fadeIn animated font-md">
                <p class="float-md-left font-small text-muted">&copy; 2025, Flow - Design by <a href="https://alithemes.com/" target="_blank">AliThemes</a></p>
